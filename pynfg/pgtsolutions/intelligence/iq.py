...
def iq_MH(G, S, X, M, noise, dens, integrand=None, mix=False, seed=False):
    ...
    :arg mix: if true, proposal distribution is over mixed CPTs. Default is 
       False.
    :type mix: bool
    :arg seed: if False, MH uses a uniform CPT as a starting point. If True, MH
       uses current CPTs as starting point.
